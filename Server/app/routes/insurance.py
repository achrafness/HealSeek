...
@router.put('/update/{insurance_id}' , dependencies=[Depends(resolve_user_temp(allowed_roles=["admin"]))])
...
@router.delete('/delete_by_id/{insurance_id}' , dependencies=[Depends(resolve_user_temp(allowed_roles=["admin"]))])
...
@router.get('/doctor/all_insurances' ,dependencies=[Depends(resolve_user_temp(allowed_roles=["doctor"]))])
...
@router.delete('/doctor/delete_insurance' , dependencies=[Depends(resolve_user_temp(allowed_roles=["doctor"]))])
