...
@router.get("/get_user_notifications/" , dependencies=[Depends(resolve_user(allowed_roles=["admin" , "patien" , "doctor"]))])
...
@router.get("/mark_all_user_notifications_as_status/{status}" , dependencies=[Depends(resolve_user(allowed_roles=["admin" , "patien" , "doctor"]))])
...
@router.delete("/delete_all_user_notifications" , dependencies=[Depends(resolve_user(allowed_roles=["admin" , "patien" , "doctor"]))])
